$(document).ready(function() {
	...
	$("#search-aktif").keyup(function() {
		...
		console.log(keyword);
		$.ajax({
			url: "<?php echo site_url('proses/cari_anggota_aktif/')?>" + keyword,
			success: function(result) {
				$("#table-body").html(result);
			}
		});
	...
	$("#search-iuran-wajib").keyup(function() {
		...
		console.log(keyword);
		$.ajax({
			url: "<?php echo site_url('proses/cari_iuran_wajib/')?>" + keyword,
			success: function(result) {
				$("#table-body").html(result);
				$(".uang").html(formatUang($(".uang").html()));
			}
	...
	$("#id-anggota").keyup(function() {
		...
		$.ajax({
			url: "<?php echo site_url('proses/cari_anggota_iuran/')?>" + keyword,
			success: function(result) {
				$("#anggota").html(result);
				//$(".uang").html(formatUang($(".uang").html()));
			}
	...
	$("#id-anggota-angsuran").keyup(function() {
		...
		//document.getElementById("nama").value=this.value;
		$.ajax({
			url: "<?php echo site_url('proses/cari_anggota_angsuran/')?>" + keyword,
			success: function(result) {
				$("#anggota").html(result);
				//$(".uang").html(formatUang($(".uang").html()));
			}
	...
	$("#jumlah").change(function() {
		...
		if ($("#ijarah").val() != "" && $("#pengembalian-pokok").val() != "") {
			...
			var pengembalian_pokok = parseInt(
				$("#pengembalian-pokok")
					.val()
					.split(".")
					.join("")
	...
	$("#id-anggota").change(function() {
		...
		console.log(keyword);
		$.ajax({
			url: "<?php echo site_url('proses/cari_nama_anggota/')?>" + keyword,
			success: function(result) {
				//$("#anggota").html(result);
	...
	$("#id-anggota-angsuran").change(function() {
		...
		$.ajax({
			url: "<?php echo site_url('proses/cari_id_pembiayaan/')?>" + keyword,
			success: function(result) {
				//$("#anggota").html(result);
		...
		$.ajax({
			url: "<?php echo site_url('proses/cari_jumlah_pembiayaan/')?>" + keyword,
			success: function(result) {
				//$("#anggota").html(result);
				document.getElementById(
					"jumlah-pembiayaan"
				).value = formatUangNoCurrency(result);
				//$("#")
			}
		});
		$.ajax({
			url: "<?php echo site_url('proses/cari_pembiayaan_pokok/')?>" + keyword,
			success: function(result) {
				//$("#anggota").html(result);
				document.getElementById(
					"pengembalian-pokok"
		...
		$.ajax({
			url: "<?php echo site_url('proses/cari_ijarah/')?>" + keyword,
			success: function(result) {
				//$("#anggota").html(result);
